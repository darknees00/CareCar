...
namespace CareCarAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class KhachHangController : ControllerBase
    {
        private readonly CareCarContext _context;

        public KhachHangController(CareCarContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<KhachHang>> PostKhachHang(KhachHang khachHang)
        {
            if (_context.KhachHangs == null)
            {
                return Problem("Entity set 'CareCarContext.KhachHangs'  is null.");
            }
